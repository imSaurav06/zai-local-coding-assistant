      ...
      <main className="container mx-auto px-4 py-16">
        <section className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Hi, I'm John Doe</h2>
            <h3 className="text-2xl md:text-3xl text-blue-400 mb-6">Full Stack JavaScript Developer</h3>
            <p className="text-lg mb-8 text-gray-300">
              I build scalable web applications using modern technologies like React, Node.js, and MongoDB. 
              With a passion for clean code and user experience, I create digital solutions that make a difference.
            </p>
            <div className="flex space-x-4">
              <Link href="/projects" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded transition-colors">
                View My Work
              </Link>
              <Link href="/contact" className="border border-blue-600 text-blue-400 hover:bg-blue-900 font-bold py-2 px-6 rounded transition-colors">
                Get In Touch
              </Link>
            </div>
          </div>
